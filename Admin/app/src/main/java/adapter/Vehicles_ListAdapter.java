...
public class Vehicles_ListAdapter extends BaseAdapter {
    ...
    Typeface face;
    public List<Vehicles_FeedItem> feedItems;
    private LayoutInflater inflater;
    public String pcatid = "";
    ProgressDialog pd;
    int pos = 0;
    public Vehicles_ListAdapter(Activity activity2, List<Vehicles_FeedItem> feedItems2) {
        activity = activity2;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.custom_vehicles, null);
        }
        TextView vehiclecompany= (TextView) convertView.findViewById(R.id.vehiclecompany);
        ImageView delete = (ImageView) convertView.findViewById(R.id.delete);
        ImageView edit = (ImageView) convertView.findViewById(R.id.edit);
        ImageView image = (ImageView) convertView.findViewById(R.id.image);
        Vehicles_FeedItem item = (Vehicles_FeedItem) feedItems.get(position);
        ...
        edit.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Vehicles_FeedItem item = (Vehicles_FeedItem) feedItems.get(position);
                Temp.vehicleedit = 1;
                Temp.vehcile_sn=item.getSn();
                Temp.vehcile_vehiclecompany=item.getVehiclecompany();
                Temp.vehcile_imgsig=item.getImgsig();
                Intent i = new Intent(context, Add_Vehicle.class);
    ...
    public class delete_product extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            try {
                String link= Temp.weblink +"delete_vehicles.php";
        ...
        public void onPostExecute(String result) {
            if (pd != null || pd.isShowing()) {
                ...
                if (result.contains("ok")) {
                    ...
                    ((Vehicle_Management) activity).removeitem(pos);
                    return;
                }
