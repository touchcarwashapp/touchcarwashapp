...
public class Vehicle_Management extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Vehicles_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle__management);
        ...
        listAdapter = new Vehicles_ListAdapter(this, feedItems);
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        Vehicles_FeedItem item = new Vehicles_FeedItem();
                        m=m+1;
