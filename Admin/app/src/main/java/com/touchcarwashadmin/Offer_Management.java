...
import adapter.Offercountlist_ListAdapter;
...
public class Offer_Management extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Offercountlist_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offer__management);
        ...
        listAdapter = new Offercountlist_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getoffercountsforadmin.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        OfferCount_FeedItem item = new OfferCount_FeedItem();
                        m=m+1;
                        item.setSn(got[m].trim());
                        m=m+1;
                        item.setVehicleid(got[m]);
                        m=m+1;
                        item.setWashcount(got[m]);
                        m=m+1;
                        item.setOffercount(got[m]);
                        m=m+1;
                        item.setCompanyname(got[m]);
                        m=m+1;
