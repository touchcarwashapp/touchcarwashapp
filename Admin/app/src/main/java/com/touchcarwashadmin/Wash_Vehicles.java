...
public class Wash_Vehicles extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Washvehicles_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wash__vehicles);
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.washveiedit = 0;
                startActivity(new Intent(getApplicationContext(),Add_Wash_Vehicles.class));
            }
        });
        text.setText("Wash Vehicles");
        ...
        listAdapter = new Washvehicles_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getwashvehicles_admin.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        WashVehicles_FeedItem item = new WashVehicles_FeedItem();
                        m=m+1;
                        item.setSn(got[m].trim());
                        m=m+1;
                        item.setRegisternumber(got[m]);
                        m=m+1;
