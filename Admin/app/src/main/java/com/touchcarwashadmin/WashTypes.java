...
import adapter.Washtypes_ListAdapter;
import data.Vehicles_For_Price_FeedItem;
import data.WashTypes_FeedItem;

public class WashTypes extends AppCompatActivity {
    ...
    public int limit = 0;
    ListView list;
    public Washtypes_ListAdapter listAdapter;
    ImageView nodata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wash_types);
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Temp.typeedit = 0;
                startActivity(new Intent(getApplicationContext(),Add_Wash_Types.class));
            }
        });
        text.setText("Wash Types");
        ...
        listAdapter = new Washtypes_ListAdapter(this, feedItems);
    ...
    public class loadstatus extends AsyncTask<String, Void, String> {
        ...
        public String doInBackground(String... arg0) {
            ...
            try {
                String link=Temp.weblink +"getwasshtypes_admin.php";
        ...
        public void onPostExecute(String result) {
            try {
                if (result.trim().contains(":%ok")) {
                    ...
                    int m = -1;
                    for (int i = 1; i <= k; i++) {
                        WashTypes_FeedItem item = new WashTypes_FeedItem();
                        m=m+1;
                        item.setSn(got[m].trim());
                        m=m+1;
                        item.setVehicleid(got[m]);
                        m=m+1;
                        item.setTypename(got[m]);
                        m=m+1;
